...
CREATE TABLE `sky_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='后台管理系统';

-- ----------------------------
-- Records of sky_admin
-- ----------------------------
INSERT INTO `sky_admin` VALUES ('1', 'sysadmin', '$2y$13$XEwO4RCPtM9bQ2uGyRE9S.ve4VwgCu2xpJbBuGIeXJ0hF1J.DS4qi', '623672782@qq.com', '13', '2130706433', '2130706433', '1', '0', '1512033870', '1515508315');
INSERT INTO `sky_admin` VALUES ('4', 'admin3', '$2y$13$1b05GD1Zt6IGZDviSZH/Bug59odxxvopWpUzwSLlfc7lxCI5SA36q', '45641631315@qq.com', '0', '0', '0', '0', '0', '1512033870', '1515510270');
...
CREATE TABLE `sky_bottomlink` (
  ...
  `linkCateId` int(11) NOT NULL DEFAULT 0 COMMENT '链接类型Id',
  `createTime` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `modifyTime` int(11) NOT NULL DEFAULT 0 COMMENT '编辑时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `sky_bottomlink` VALUES ('1', '百度', null, 'http://www.baidu.com', '1', '1515502087', '1515502087');
...
CREATE TABLE `sky_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='文章分类表';
...
INSERT INTO `sky_category` VALUES ('11', '图片测试', '8', '1515214879', '1515214879', '图片测试', 'normal', 'image', '0', '0');
INSERT INTO `sky_category` VALUES ('12', '首页轮播', '15', '1515419069', '1515419069', '首页轮播', 'normal', 'image', '0', '0');
INSERT INTO `sky_category` VALUES ('13', '测试视频', '10', '1515499468', '1515499468', '测试视频', 'normal', 'video', '0', '0');
INSERT INTO `sky_category` VALUES ('14', '测试文件', '11', '1515504488', '1515504488', '测试文件', 'normal', 'file', '0', '0');
...
CREATE TABLE `sky_common` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='常用配置表';
...
INSERT INTO `sky_common` VALUES ('15', 'sylb', '首页轮播', 'navigation', '首页轮播', '0');
...
CREATE TABLE `sky_download` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `descr` varchar(50) NOT NULL COMMENT '文件名称',
  `uri` varchar(150) NOT NULL COMMENT '下载地址',
  `createTime` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `modifyTime` int(11) NOT NULL COMMENT '编辑时间',
  `categoryId` int(11) NOT NULL DEFAULT 0 COMMENT '文件分类',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='下载中心表';

-- ----------------------------
-- Records of sky_download
-- ----------------------------
INSERT INTO `sky_download` VALUES ('1', '测试文件', 'http://18upload.oss-cn-hangzhou.aliyuncs.com/upload/autoDiagnoseUpdate.exe', '1515504621', '1515504621', '14', null);
...
CREATE TABLE `sky_naire` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='问卷调查表';

-- ----------------------------
-- Records of sky_naire
-- ----------------------------
INSERT INTO `sky_naire` VALUES ('11', '测试问卷调查试卷-编辑', '2', '1', '范德萨范德萨发', '0', '1515056724', '1515071447');
INSERT INTO `sky_naire` VALUES ('12', '测试问卷调查', '1', '0', '测试问卷调查', '0', '1515510676', '1515510676');
...
CREATE TABLE `sky_nairevote` (
  ...
  UNIQUE KEY `ids_naireId_voteId` (`naireId`,`voteId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='调查试卷与调查题关系表';

-- ----------------------------
-- Records of sky_nairevote
-- ----------------------------
INSERT INTO `sky_nairevote` VALUES ('11', '15', '1');
INSERT INTO `sky_nairevote` VALUES ('11', '16', '2');
INSERT INTO `sky_nairevote` VALUES ('12', '17', '1');
...
CREATE TABLE `sky_photo` (
  ...
  `categoryId` tinyint(4) NOT NULL DEFAULT 0 COMMENT '分类ID',
  `isDelete` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否删除',
  `createTime` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `modifyTime` int(11) DEFAULT 0 COMMENT '编辑时间',
  `link` varchar(150) DEFAULT NULL COMMENT '链接地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='图讯社园表';

-- ----------------------------
-- Records of sky_photo
-- ----------------------------
INSERT INTO `sky_photo` VALUES ('1', 'http://seving-weixin.oss-cn-shenzhen.aliyuncs.com/upload/image/2018-01-08/284805119480580868.jpeg', '百度首页', '12', '0', '1515415203', '1515419110', 'www.baidu.com');
...
CREATE TABLE `sky_question` (
  ...
  `modifyTime` int(11) DEFAULT 0 COMMENT '编辑时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='微课试题表';
...
INSERT INTO `sky_question` VALUES ('32', '擦擦撒萨达撒旦', '', 'multi', '14', '[\"A\",\"B\",\"C\"]', '0', '1515510725', '1515510725');
...
INSERT INTO `sky_questoptions` VALUES ('32', '啊啊是', '', '0');
INSERT INTO `sky_questoptions` VALUES ('32', '大苏打大撒', '', '1');
INSERT INTO `sky_questoptions` VALUES ('32', '大三大四', '', '2');
...
CREATE TABLE `sky_schedule` (
  ...
  `lessonStartTime` varchar(20) NOT NULL DEFAULT '' COMMENT '上课时间段开始',
  `lessonEndTime` varchar(20) DEFAULT NULL COMMENT '结束时间',
  ...
  `teachPlace` varchar(150) DEFAULT NULL,
  `gradeClassId` int(11) NOT NULL DEFAULT 0 COMMENT '班级ID',
  `gradeClass` varchar(150) DEFAULT NULL COMMENT '班级名称',
  `isPublish` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否发布（0否1是）',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='学院课表表';

-- ----------------------------
-- Records of sky_schedule
-- ----------------------------
INSERT INTO `sky_schedule` VALUES ('1', '1', '毛泽东思想与政治', '2018-01-17', '22:40', '23:05', '3', '王五', '6', '9教804', '1', '政治思想班', '0', '', '0', '0', '1515508945', '1515508945', '');
...
INSERT INTO `sky_testpaper` VALUES ('7', '测试试卷', '1', '0', 'nopublish', '0', '0', '', '测试', '1515510725', '1515510725', '0', '', '0');
...
INSERT INTO `sky_testpaperquestion` VALUES ('7', '32', '5', '1');
...
-- Records of sky_user
-- ----------------------------
INSERT INTO `sky_user` VALUES ('1', 'wangtao', '$2y$13$mPw8DNmRKa/HfOVMTCqdUOTuz9/uAgFCI6h5x4JoantKL6OVfB6Bq', '', '623672780@qq.com', '1', '0', '', '0', '0', '0', '1512444422', '1515510830');
INSERT INTO `sky_user` VALUES ('2', 'test', '$2y$13$/Kq26g4ks9Peajfc8vi/GOI1ZEk9zdW.JnjgTfqCJ6MMQiccRZTUu', '13648035706', '623672781@qq.com', '1', '0', '', '0', '0', '1', '1514450535', '1514452610');
INSERT INTO `sky_user` VALUES ('3', 'test2', '$2y$13$BFnRh0zadd5yz1HNPR1lBOMrdNS1cSNdMrIzufN5ZqAbbGvOQCnjG', '', 'd32423212@qq.com', '1', '0', '', '0', '0', '1', '1514452307', '1514452307');
...
CREATE TABLE `sky_video` (
  ...
  `videoImg` varchar(150) DEFAULT NULL COMMENT '视频背景图',
  `descr` varchar(150) NOT NULL DEFAULT '' COMMENT '视频描述',
  `categoryId` tinyint(4) DEFAULT 0 COMMENT '分类ID',
  `isDelete` tinyint(2) DEFAULT 0 COMMENT '是否删除',
  `createTime` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  `modifyTime` int(11) DEFAULT 0 COMMENT '编辑时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='视讯社园表';

-- ----------------------------
-- Records of sky_video
-- ----------------------------
INSERT INTO `sky_video` VALUES ('1', 'http://18upload.oss-cn-hangzhou.aliyuncs.com/upload/片头动画.mp4', null, '测试', '13', '1', '1515500026', '1515501112');
INSERT INTO `sky_video` VALUES ('2', 'http://18upload.oss-cn-hangzhou.aliyuncs.com/upload/片头动画.mp4', null, '这是测试的视频', '13', '1', '1515500343', '1515501114');
INSERT INTO `sky_video` VALUES ('3', 'http://18upload.oss-cn-hangzhou.aliyuncs.com/upload/片头动画.mp4', 'http://18upload.oss-cn-hangzhou.aliyuncs.com/upload/image/2018-01-09/400719085906289789.png', '测试视频12', '13', '0', '1515501366', '1515501815');
...
INSERT INTO `sky_vote` VALUES ('8', '范德萨范德萨发', '', 'radio', '1', '0', '0', '0', '1515071074', '1515071074');
INSERT INTO `sky_vote` VALUES ('9', '范德萨范德萨发', '', 'radio', '1', '0', '0', '0', '1515071147', '1515071147');
INSERT INTO `sky_vote` VALUES ('10', '第二道调查试题咯哦', '', 'multi', '1', '0', '0', '0', '1515071147', '1515071147');
INSERT INTO `sky_vote` VALUES ('11', '范德萨范德萨发', '', 'radio', '1', '0', '0', '0', '1515071203', '1515071203');
INSERT INTO `sky_vote` VALUES ('12', '第二道调查试题咯哦', '', 'multi', '1', '0', '0', '0', '1515071203', '1515071203');
INSERT INTO `sky_vote` VALUES ('13', '范德萨范德萨发', '', 'radio', '1', '0', '0', '0', '1515071363', '1515071363');
INSERT INTO `sky_vote` VALUES ('14', '第二道调查试题咯哦', '', 'multi', '1', '0', '0', '0', '1515071364', '1515071364');
INSERT INTO `sky_vote` VALUES ('15', '范德萨范德萨发', '', 'radio', '1', '0', '0', '0', '1515071447', '1515071447');
INSERT INTO `sky_vote` VALUES ('16', '第二道调查试题咯哦', '', 'multi', '1', '0', '0', '0', '1515071447', '1515071447');
INSERT INTO `sky_vote` VALUES ('17', '测试试题一', '', 'multi', '1', '0', '0', '0', '1515510676', '1515510676');
...
INSERT INTO `sky_voteoptions` VALUES ('发撒发撒发到', '8', '0', '0', '1515071074', '1515071074');
INSERT INTO `sky_voteoptions` VALUES ('范德萨发', '8', '0', '1', '1515071074', '1515071074');
INSERT INTO `sky_voteoptions` VALUES ('发撒发撒发到', '9', '0', '0', '1515071146', '1515071146');
INSERT INTO `sky_voteoptions` VALUES ('范德萨发', '9', '0', '1', '1515071146', '1515071146');
INSERT INTO `sky_voteoptions` VALUES ('大苏打', '10', '0', '0', '1515071146', '1515071146');
INSERT INTO `sky_voteoptions` VALUES ('大大', '10', '0', '1', '1515071146', '1515071146');
INSERT INTO `sky_voteoptions` VALUES ('大大大大', '10', '0', '2', '1515071146', '1515071146');
INSERT INTO `sky_voteoptions` VALUES ('发撒发撒发到', '11', '0', '0', '1515071202', '1515071202');
INSERT INTO `sky_voteoptions` VALUES ('范德萨发', '11', '0', '1', '1515071202', '1515071202');
INSERT INTO `sky_voteoptions` VALUES ('大苏打', '12', '0', '0', '1515071202', '1515071202');
INSERT INTO `sky_voteoptions` VALUES ('大大', '12', '0', '1', '1515071202', '1515071202');
INSERT INTO `sky_voteoptions` VALUES ('大大大大', '12', '0', '2', '1515071202', '1515071202');
INSERT INTO `sky_voteoptions` VALUES ('发撒发撒发到', '13', '0', '0', '1515071363', '1515071363');
INSERT INTO `sky_voteoptions` VALUES ('范德萨发', '13', '0', '1', '1515071363', '1515071363');
INSERT INTO `sky_voteoptions` VALUES ('大苏打', '14', '0', '0', '1515071363', '1515071363');
INSERT INTO `sky_voteoptions` VALUES ('大大', '14', '0', '1', '1515071363', '1515071363');
INSERT INTO `sky_voteoptions` VALUES ('大大大大', '14', '0', '2', '1515071363', '1515071363');
INSERT INTO `sky_voteoptions` VALUES ('发撒发撒发到', '15', '0', '0', '1515071447', '1515071447');
INSERT INTO `sky_voteoptions` VALUES ('范德萨发', '15', '0', '1', '1515071447', '1515071447');
INSERT INTO `sky_voteoptions` VALUES ('大苏打', '16', '0', '0', '1515071447', '1515071447');
INSERT INTO `sky_voteoptions` VALUES ('大大', '16', '0', '1', '1515071447', '1515071447');
INSERT INTO `sky_voteoptions` VALUES ('大大大大', '16', '0', '2', '1515071447', '1515071447');
INSERT INTO `sky_voteoptions` VALUES ('大大是', '17', '0', '0', '1515510676', '1515510676');
INSERT INTO `sky_voteoptions` VALUES ('大大撒', '17', '0', '1', '1515510676', '1515510676');
INSERT INTO `sky_voteoptions` VALUES ('大法师', '17', '0', '2', '1515510676', '1515510676');
