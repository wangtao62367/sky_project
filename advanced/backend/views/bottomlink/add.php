...
<ul class="forminfo">
    <li><label>链接名称<b>*</b></label><?php echo Html::activeTextInput($model, 'linkName',['class'=>'dfinput','placeholder'=>'链接名称不能为空，且长度为2-20个字'])?><i>链接名称不能为空，且长度为2-20个字</i></li>
    ...
    <li><label>链接地址<b>*</b></label><?php echo Html::activeTextInput($model, 'linkUrl',['class'=>'dfinput','placeholder'=>'URL地址必须是全路径;如：百度 http://www.baidu.com'])?><i>URL地址必须是全路径;如：百度 http://www.baidu.com</i></li>
