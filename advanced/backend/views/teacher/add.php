...
<ul class="forminfo">
    <li><label>教师名称<b>*</b></label><?php echo Html::activeTextInput($model, 'trueName',['class'=>'dfinput'])?><i>教师名称不能为空，且长度为2-20个字</i></li>
    <li><label>性&nbsp;&nbsp;别<b>*</b></label><?php echo Html::activeRadioList($model, 'sex', ['1'=>'男','2'=>'女'])?></li>
    <li><label>教师职称<b>*</b></label><?php echo Html::activeTextarea($model, 'positionalTitles',['class'=>'textinput'])?><i>教师职称不能为空，且描述长度为2-50个字。例如：高级教师、教学主任等等</i></li>
