...
<ul class="forminfo">
    <li><label>教学地点</label><?php echo Html::activeTextInput($model, 'text',['class'=>'dfinput'])?><i>教学地点不能超过10个字符</i></li>
    <li><label>详细地址</label><?php echo Html::activeTextarea($model, 'address',['class'=>'textinput'])?><i>教学地点详细地址的描述</i></li>
