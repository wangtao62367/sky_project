...
<ul class="forminfo">
    ...
    <li><label>报名时间<b>*</b></label><?php echo Html::activeTextInput($model, 'joinStartDate',['class'=>'dfinput joinStartDate','autocomplete'=>'off','style'=>'width:240px;','placeholder'=>'开始时间'])?> - 
    <?php echo Html::activeTextInput($model, 'joinEndDate',['class'=>'dfinput joinEndDate','autocomplete'=>'off','style'=>'width:240px;','placeholder'=>'结束时间'])?>
    </li>
    
    <li><label>开班时间<b>*</b></label>
    <?php echo Html::activeTextInput($model, 'openClassTime',['class'=>'dfinput openClassTime','autocomplete'=>'off','style'=>'width:240px;','placeholder'=>'开班时间'])?>
    </li>
    
    <li><label>结业时间<b>*</b></label>
    <?php echo Html::activeTextInput($model, 'closeClassTime',['class'=>'dfinput closeClassTime','autocomplete'=>'off','style'=>'width:240px;','placeholder'=>'结业时间'])?>
    </li>
