...
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="<?= Yii::$app->language ?>" <?php if($params['webCfgs']['webStyle'] == 'black-and-white'): ?> style="-webkit-filter: grayscale(100%);filter:progid:DXImageTransform.Microsoft.BasicImage(graysale=1);" <?php endif;?>>
<head>
